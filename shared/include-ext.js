...
(function() {
    ...
    var cdn = 'http://cdn.sencha.com/ext/gpl/4.2.1/';
    
    if (includeCSS) {
        
        document.write('<link rel="stylesheet" type="text/css" href="'+ cdn + 'resources/css/ext-all' + suffix + '-debug.css"/>');
        ...
        //document.write('<link href="http://cdn.sencha.com/ext/gpl/4.2.1/resources/css/ext-all.css" rel="stylesheet" />');
    }
    //document.write('<script type="text/javascript" src="' + path + window.location.pathname + 'ext/ext-all-debug' + (rtl ? '-rtl' : '') + '.js"></script>');
    document.write('<script src="http://cdn.sencha.com/ext/gpl/4.2.1/ext-all.js"></script>');
    ...
    if (neptune) {
        ...
        //neptunePath = (repoDevMode ? path + '/..' : path) + window.location.pathname + 'ext/packages/ext-theme-neptune/build/ext-theme-neptune' + (repoDevMode ? '-dev' : '') + '.js';
        neptunePath = cdn+'packages/ext-theme-neptune/build/ext-theme-neptune' + (repoDevMode ? '-dev' : '') + '.js';
